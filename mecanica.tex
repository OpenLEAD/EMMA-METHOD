...
\subsubsubsection{Malha:} A análise foi modelada com elementos unidimensionais
...
\subsubsubsection{Material:} O material utilizado é o alumínio EN AW-6060 (norma
...
\subsubsubsection{Condições de Contorno:} Para os braços de ancoragem, foram
...
\subsubsubsection{Carregamento:} O carregamento utilizado para simulação
