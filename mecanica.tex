...
interface do tipo rótula, figura~\ref{fig::spindle}, que permitem até
$10^{\circ}$ de inclinação entre a haste e à base, além de $75~mm$ de regulagem
do comprimento, pela rosca da haste. Esta peça também permite ajuste de altura
da ''perna'' pela haste rosqueada.
...
Para alcançar as regiões da pá mais próximas ao rotor, e garantir a qualidade
ideal de revestimento, é necessária a elevação da base do manipulador em pelo
menos $200~mm$.
...
acionamento.
Um conjunto de cilindros e guias garantem o movimento preciso e robustez,
recebendo os esforços provenientes do robô e transmitindo direto para a
estrutura, prevenindo que estes atuem no macaco mecânico.
...
deve-se permitir a correção de pequenos erros de posicionamento no
...
equipamentos e avaliados, por exemplo tensão, Fator de Segurança,
...
em todas as direções e rotação livre. Para os pés de apoio, definiu-se restição
