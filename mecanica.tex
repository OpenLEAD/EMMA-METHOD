...
altura da ''perna'' pela haste rosqueada. %TODO Conferir Estevao
...
figura~\ref{fig::aluminio_estrutural}, na seção~\ref{sec::perfil}. %TODO Estevao
% conferir figura
...
O relatório com o resultado de saída do programa encontra-se no anexo
\ref{append::skf}.
...
atender ao critério, fornecendo um Fator de Segurança de $2,1$. %TODO Estevao
% mais uma justificativa, preco?
